...
var windowsInfos = new Array();
	...
	var markIcoRed = new BMap.Icon('<c:url value="resources/images/map/coordinate.gif"></c:url>', new BMap.Size(24, 31));// 红色
	markIcoRed.setAnchor(new BMap.Size(14, 32));
    var markIcoBlue = new BMap.Icon('<c:url value="resources/images/map/coordinate.gif"></c:url>', new BMap.Size(24, 31)); // 蓝色
